...
if (strlen($deleteOK)==0) $deleteOK = 0;
               ...
               <?php include('sidebar.php'); ?>
                ...
                <div id="page-content">
                    ...
                    <form action="" method="post" class="form-horizontal form-box">
                        <h4 class="form-box-header">ABM USUARIOS</h4>
  						<div class="form-box-content">
                            <div class="form-group">
                                <label class="control-label col-md-2" for="example-input-small">Nombre:</label>
                                <div class="col-md-3">
                                    <input type="text" id="nombre_usuario" name="nombre_usuario" maxlength="250" tabindex="1" value="<?php echo $nombre; ?>" class="form-control input-sm"/>
                                </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-3">
                                    <input type="email" id="mail_usuario" name="mail_usuario" maxlength="100" tabindex="2" value="<?php echo $email; ?>" class="form-control input-sm" />
                                    </div>
                             ...
                             <div class="form-group">
                                <label class="control-label col-md-2" for="example-input-small">Descripción:</label>
                                <div class="col-md-3">
                                    <input type="text" id="descripcion_usuario" name="descripcion_usuario" maxlength="100" tabindex="3" value="<?php echo $descripcion; ?>" class="form-control input-sm" />
                                    </div>
                             ...
                             <div class="form-group">
                                ...
                                <div class="col-md-3">
                                    <input type="password" id="password_usuario" name="password_usuario" maxlength="100" tabindex="3" value="<?php echo $password; ?>" class="form-control input-sm" />
                            	</div>
                    ...
                    <h3 class="page-header">USUARIOS CREADOS</h3>               
                    ...
                    <thead>
                        <tr>
                            ...
                            <th>Descripción</th>
                            <th>Password</th>
                            <th class="cell-medium text-center"><i class="fa fa-bolt"></i> Acciones</th>
                        </tr>
                    </thead>
				...
				?>
					<tr>
                        ...
                        <div class="btn-group">
                            ...
                            <a href="formulario-edicion-usuarios.php?id_usuario=<?php echo $fila['id_usuario'];?>&acc=modificacion"><input type="button" value="Editar" class="btn btn-xs btn-success" /></a>
                            <a href="baja-usuario.php?id_usuario=<?php echo $fila['id_usuario'];?>"><input type="button" value="Borrar" class="btn btn-xs btn-danger"/></a>
                        </div>
                        </td>
					</tr>
				<?php 
